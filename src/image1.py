...
def detect_target(filepass):
    ...
    cv2.circle(img, (coordinates_x["top"], coordinates_y["top"]), 8, (0, 0, 255), -1)
    cv2.circle(img, (coordinates_x["left"], coordinates_y["left"]), 8, (0, 255, 0), -1)
    cv2.circle(img, (coordinates_x["right"], coordinates_y["right"]), 8, (255, 0, 0), -1)
